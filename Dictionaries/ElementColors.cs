...
namespace TerraTyping
{
    ...
    public static class ElementColors
    {
        ...
        {
            colorArray = new Dictionary<Element, Color>
            {
        ...
        public static Color GetColor(Element element) => colorArray[element];

        private static Dictionary<Element, Color> colorArray;
    }
}
